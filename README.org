...
*dman* is a simple, POSIX-compliant, policy-based directory pruner written in C99 designed for high-performance cleanup of volatile cache and transient storage structures. *dman* does not rely on external dependencies nor any GNU extensions in favour of portable C99.
